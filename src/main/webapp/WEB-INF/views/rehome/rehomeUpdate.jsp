...
<form id='update' action='update' method='post'>
  ...
  <br><br>
  게시판번호<input type="text" name="bno" value='${rehomeGetOne.bno }' ><br>
  분양글번호<input type="text" name="rno" value='${rehomeGetOne.rno }'><br>
  회원번호<input type="text" name="mno" value='${rehomeGetOne.mno }'><br>
  성별<select form='update' name="gender" selected><br>
    <option value="0">암컷</option>
    <option value="1">수컷</option>
    <option value="2">모름</option>
  </select><br>
  접종여부<select name="neut" form='update' selected><br>
    <option value="0">했음</option>
    <option value="1">안했음</option>
    <option value="2">모름</option>
  </select><br>
  중성화여부<select name="vac" form='update' selected><br>
    <option value="0">했음</option>
    <option value="1">안했음</option>
    <option value="2">모름</option>
  </select><br>
  ...
  <textarea id="cont_b" name="cont_b" rows="20" cols="100" value='${rehomeGetOne.cont_b }'>
